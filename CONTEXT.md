...
Avec 75 points c'est indolore ; à 500 il faudra une mise à jour différentielle.
...
- **Passage par `Special:FilePath`** plutôt que par l'URL de vignette renvoyée
  ...
  gère Commons et Wikipédia fr ; en pratique, **les 75 fichiers sont sur
...
- **Attribution photo non affichée** — les 75 clichés sont libres, mais 69
...
d'Amboise » se classe à *royal* et non à *Amboise*, et les douze fiches qui ne
commencent pas par « Château » (Cité de Carcassonne, Forteresse de Salses,
Manoir d'Ango, Forteresse royale de Chinon, Palais des papes d'Avignon,
Citadelle de Sisteron…) se dispersent dans la liste. C'est la lecture littérale de
...
4. Import **Wikidata** (identités, coordonnées) et **POP / Mérimée** (statut
   patrimonial) pour passer de 35 à ~500 fiches. **35 → 50 → 75 fait à la main
   le 2026-08-26**, en deux passes (15 puis 25 fiches saisies depuis Wikipédia
   fr, mêmes champs, aucun connecteur automatisé écrit) ; l'écart avec les
   ~500 visées et le branchement d'un vrai import Wikidata / POP restent à
   faire. La structure de données est déjà taillée pour ça.
5. ~~Vérification des licences photo, fiche par fiche~~ — faite le 2026-08-26,
   rejouée deux fois le même jour (50 puis 75 fiches), voir [PHOTOS.md](PHOTOS.md).
